const POSTES = [
  { titre: "Styliste senior", type: "CDI — Paris", desc: "Conception des collections femme et homme, de l'esquisse à l'industrialisation." },
  { titre: "Développeur(se) e-commerce", type: "CDI — Remote", desc: "Stack Next.js / TypeScript / Prisma. Amélioration de l'expérience d'achat en ligne." },
  { titre: "Chargé(e) de communication", type: "CDI — Paris", desc: "Gestion des réseaux sociaux, partenariats presse et contenu éditorial." },
];
